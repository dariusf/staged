...
Require Import Binding.Inc. (*Binding.Sum.*)
...
#[export] Instance ArrEqC : EqCore2 Arr :=
  λ A B f g, ∀ x, f x = g x.
Arguments ArrEqC /.

#[export] Instance ArrEq : Equiv2 Arr.
Proof.
  split; intros; congruence.
Qed.

#[export] Instance SubEqC {F} {FP : SetPureCore F} : EqCore2 Sub :=
  λ A B f g, ∀ x, f x = g x.
Arguments SubEqC /.

#[export] Instance SubEq {F} {FP : SetPureCore F} : Equiv2 Sub.
Proof.
  split; intros; congruence.
Qed.
...
Section SetInstances.
  ...
  Proof.
    split; [unfold equal; simpl; congruence .. |].
